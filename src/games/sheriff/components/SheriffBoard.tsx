...
import { readGameState, useSheriff } from '../hooks/useSheriff';
...
// ─────────────────────────────────────────────────────────────────────────────
function MarketDisplay({ players, myId }: { players: import('@core/types/player').Player[]; myId: string }) {
  return (
    <div className="space-y-2">
      {players.map((p) => {
...
function EndRoundPanel({
  ...
  gameState: SheriffGameState;
  players: import('@core/types/player').Player[];
  myId: string;
  isHost: boolean;
...
function SheriffLobby({
  ...
  room: import('@core/types/room').Room | null;
  players: import('@core/types/player').Player[];
  playerId: string;
  isHost: boolean;
