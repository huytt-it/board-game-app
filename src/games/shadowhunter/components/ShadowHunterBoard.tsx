...
import { useShadowHunter } from '../hooks/useShadowHunter';
...
function ActionPanel({
  ...
  gs: SHGameState;
  myData: ReturnType<typeof import('../hooks/useShadowHunter').useShadowHunter>['myData'];
  ...
  onSkipArea: () => void;
  onUseArea: (opts?: Parameters<ReturnType<typeof import('../hooks/useShadowHunter').useShadowHunter>['useAreaAction']>[0]) => void;
