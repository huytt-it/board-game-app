import type { BaseGameData } from '@core/types/player';
import type { RoomConfig, RoomGameState } from '@core/types/room';
...
// All Clocktower day/night state — stored in room.gameState.
export interface ClocktowerGameState extends RoomGameState {
  dayCount: number;
