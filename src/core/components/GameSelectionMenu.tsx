...
import { GAME_REGISTRY, type GameRegistryEntry } from '@core/lib/gameRegistry';
    ...
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {GAME_REGISTRY.map((game) => (
        ...
        >
          ...
          <div className="mb-4 text-5xl transition-transform duration-300 group-hover:scale-110">{game.icon}</div>
          <h3 className="mb-2 text-lg font-bold text-white">{game.label}</h3>
